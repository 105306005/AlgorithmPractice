// an algorithm that find Minimal Spanning Tree(MST)
// make a node first
class Node {
  constructor(value) {
    this.value = value;
...
//connect the node with edge that have a weight
...
//start the function of Prime Algorithm
let bucket = [];
function mstPrime(startNode) {
  let mstEdges = [];
